...
@section('title','ROLES & PERMISSIONS LIST')
                ...
                <div class="nk-block nk-block-lg">
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h4 class="nk-block-title">ROLES & PERMISSIONS LIST</h4>
                            ...
                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                ...
                                <tr class="nk-tb-item">
                                    ...
                                    <td class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead">SuperAdmin <span class="dot dot-success d-md-none ml-1"></span></span>
