                                ...
                                <div class="card">
                                    <div class="nk-ecwg nk-ecwg6">
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                <div class="card-title">
                                                    <h6 class="title">Today Active Users</h6>
                                                </div>
                                            </div>
                                            <div class="data">
                                                <div class="data-group">
                                ...
                                <div class="card">
                                    <div class="nk-ecwg nk-ecwg6">
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                <div class="card-title">
                                                    <h6 class="title">Today Merchant User</h6>
                                                </div>
                                            </div>
                                            <div class="data">
                                                <div class="data-group">
                                ...
                                <div class="card">
                                    <div class="nk-ecwg nk-ecwg6">
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                <div class="card-title">
                                                    <h6 class="title">Today Delivery Boy Users</h6>
                                                </div>
                                            </div>
                                            <div class="data">
                                                <div class="data-group">
                                ...
                                <div class="card">
                                    <div class="nk-ecwg nk-ecwg6">
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                <div class="card-title">
                                                    <h6 class="title">Total Ongoing Orders</h6>
                                                </div>
                                            </div>
                                            <div class="data">
                                                <div class="data-group">
                                ...
                                <div class="card">
                                    <div class="nk-ecwg nk-ecwg6">
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                <div class="card-title">
                                                    <h6 class="title">Total Completed Order</h6>
                                                </div>
                                            </div>
                                            <div class="data">
                                                <div class="data-group">
                            ...
                            <div class="col-xxl-4 col-md-8 col-lg-6">
                                <div class="card h-100">
                                    <div class="card-inner">
                                        <div class="card-title-group mb-2">
                                            <div class="card-title">
                                                <h6 class="title">Top Merchant Users</h6>
                                            </div>
                                            <div class="card-tools">
                                                <div class="dropdown">
                                                    <a href="#" class="dropdown-toggle link link-light link-sm dropdown-indicator" data-toggle="dropdown">Weekly</a>
                                        ...
                                        <ul class="nk-top-products">
                                            <li class="item">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <div class="price">Bussiness Name</div>
                                                </div>
                                                <div class="total">
                                                    <div class="amount">Settlement Account</div>
                                                    <div class="count">Vat Number</div>
                                                </div>
                                            </li>
                                            <li class="item">
                                                <div class="thumb">
